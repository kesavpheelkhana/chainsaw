package bot.ilda.infra.adapters.rest;

import bot.ilda.application.usecases.CityManagementUseCase;
import bot.ilda.domain.vo.Id;
import bot.ilda.domain.vo.State;
import bot.ilda.infra.adapters.rest.input.request.CityRequest;
import bot.ilda.infra.adapters.rest.input.response.CityResponse;
